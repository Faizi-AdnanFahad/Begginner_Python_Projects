...
class MyTestCase(unittest.TestCase):
    ...
    def test_case5(self):
        alan = Member.constructor4("Alan")
        mark = Member.constructor4("Mark")
        tom = Member.constructor4("Tom")
        ...
        self.assertTrue(alan.getTrainer() is not None and alan.getTrainer() == jared)
        self.assertTrue(mark.getTrainer() == jon)

        self.assertTrue(tom.getTrainer() is None)

        tom.referTrainer(mark)
        self.assertTrue(tom.getTrainer() is not None and tom.getTrainer() == jon)

        tom.referTrainer(alan)
        self.assertTrue(tom.getTrainer() is not None and tom.getTrainer() == jared)

        alan.swapTrainer(mark)
        self.assertTrue(alan.getTrainer() is not None and alan.getTrainer() == jon)
        self.assertTrue(mark.getTrainer() is not None and mark.getTrainer() == jared)

        mark.swapTrainer(alan)
        self.assertTrue(alan.getTrainer() is not None and alan.getTrainer() == jared)
        self.assertTrue(mark.getTrainer() is not None and mark.getTrainer() == jon)
