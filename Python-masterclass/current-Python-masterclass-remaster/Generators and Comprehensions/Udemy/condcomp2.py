...
# print(meals)
#
# mealsComp = [meal if 'spam' not in meal else 'a meal skipped' for meal in menu]
# print(mealsComp)
#
# x = 12
...
# the last else statement only gets executed if all of the previous conditions were false
