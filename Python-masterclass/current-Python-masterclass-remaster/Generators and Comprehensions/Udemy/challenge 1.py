...
output_comp = [len(word) for word in text.split(' ')]
print(output_comp)
...
output_comp = [(word, len(word)) for word in text.split(' ')]
output_comp_set = {(word, len(word)) for word in text.split(' ')}  # avoiding duplicates
print(output_comp)
print(output_comp_set)
